...
public class SurveyResultDTO {
	...
	public String toString() {
		return "SurveyResultDTO [surveySeq=" + surveySeq + ", raterId=" + raterId + ", appraiseeId=" + appraiseeId
				...
				+ ", max=" + max + ", avg=" + avg + ", min=" + min + ", tot=" + tot + ", rank=" + rank + ", rnum="
				+ rnum + ", getSurveySeq()=" + getSurveySeq() + ", getRaterId()=" + getRaterId() + ", getAppraiseeId()="
				+ getAppraiseeId() + ", getAnonymitySeq()=" + getAnonymitySeq() + ", getEmployeeName()="
				+ getEmployeeName() + ", getGradeName()=" + getGradeName() + ", getQuestionTypeCode()="
				+ getQuestionTypeCode() + ", getQuestionContent()=" + getQuestionContent() + ", getItemContent()="
				+ getItemContent() + ", getItemScore()=" + getItemScore() + ", getDepartmentName()="
				+ getDepartmentName() + ", getQuestionSeq()=" + getQuestionSeq() + ", getItemSeq()=" + getItemSeq()
				+ ", getAnswerContent()=" + getAnswerContent() + ", getAnonymityCode()=" + getAnonymityCode()
				+ ", getRaterName()=" + getRaterName() + ", getRaterGrade()=" + getRaterGrade()
				+ ", getRaterDepartmentName()=" + getRaterDepartmentName() + ", getQuestionType()=" + getQuestionType()
				+ ", getScore()=" + getScore() + ", getGrd()=" + getGrd() + ", getMax()=" + getMax() + ", getAvg()="
				+ getAvg() + ", getMin()=" + getMin() + ", getTot()=" + getTot() + ", getRank()=" + getRank()
