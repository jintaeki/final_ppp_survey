...
public class PagingDTO {
		...
		private Date surveyStartDateLeft;
		@DateTimeFormat(pattern="yyyy-MM-dd")
		private Date surveyStartDateRight;
		...
		public Date getSurveyStartDateLeft() {
			return surveyStartDateLeft;
		}

		public void setSurveyStartDateLeft(Date surveyStartDateLeft) {
			this.surveyStartDateLeft = surveyStartDateLeft;
		}

		public Date getSurveyStartDateRight() {
			return surveyStartDateRight;
		}

		public void setSurveyStartDateRight(Date surveyStartDateRight) {
			this.surveyStartDateRight = surveyStartDateRight;
		}
		...
		public String toString() {
			return "PagingDTO [surveySeq=" + surveySeq + ", totalRows=" + totalRows + ", totalPageNo=" + totalPageNo
					...
					+ month + ", rnum=" + rnum + ", surveyStartDateLeft=" + surveyStartDateLeft
					+ ", surveyStartDateRight=" + surveyStartDateRight + "]";
		}
