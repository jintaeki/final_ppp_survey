...
public interface IMappingRepository {
	...
	void setMapping(@Param("surveyId") int surveyId, @Param("year") int year, @Param("number") int number);
	...
	void insertAppraisee(int surveyId, int raterId, int appraiseeId);
	
	// 피평가자를 피평가자 목록에서 제외
	void deleteAppriesee(int raterId, int appraiseeId);
