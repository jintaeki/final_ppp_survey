...
<form:form modelAttribute="SLD" style="display:inline-flex; border: 1px solid black;" id="form">
	<div class="container">
		<div class="row">
			...
			<div class="col-3">
				<input type="date" name="surveyStartDate" value="<fmt:formatDate value='${SLD.surveyStartDate}' pattern='yyyy-MM-dd' />">
				~ <input type="date" name="surveyClosedDate" value="<fmt:formatDate value='${SLD.surveyClosedDate}' pattern='yyyy-MM-dd' />">
			</div>
			<div class="col-3">
...
<div class="icon_line" id="newItem" style="display: none;">
	...
	<button onclick="delete_btn(this)">
