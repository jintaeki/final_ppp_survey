...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/pop_another.js"></script>
      ...
      <div class="survey_list_form_upper_dv">
         <form action="<c:url value='/mapping/another.do'/>" method="get" class="survey_list_form">
            ...
            <div class="input-group-append">
               ...
               <input type="button" style="margin-left:10px;" class="btn btn-outline-secondary" onclick="reset_btn_mapping_pop(${pagingdto.surveySeq})" value="초기화">
            </div>
            </div>
         </form>
      </div>
