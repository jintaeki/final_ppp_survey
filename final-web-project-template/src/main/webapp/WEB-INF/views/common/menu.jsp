...
<!-- 	</table> -->
	...
	<table style="margin: auto; margin-top: 200px; font-size:20px;
     background:#aba2a4; border-radius: 20px 20px 20px 20px;">
		<tr style="/* border:5px solid #665998; *//*  background:#665998; */">
			<th class="col-5" style="font-size:15px; color:white; text-align:center;">부서명</th>
			<th class="col-5" style="font-size:15px; color:white; text-align:center;">이름</th>
		</tr>

		<tr>
			<td class="col-7" style="background: #00000087; border-radius: 1px 0px 0px 20px;"><div class="menu_profile_text">${checked.raterDepartmentName }</div></td>
			<td class="col-7" style="background: #00000087; border-radius: 0px 1px 20px 0px;"><div class="menu_profile_text">${checked.raterName }</div></td>
		</tr>
