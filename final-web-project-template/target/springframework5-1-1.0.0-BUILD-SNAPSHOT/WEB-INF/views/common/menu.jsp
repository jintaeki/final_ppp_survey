...
<ul class="nav flex-column">
	<li class="nav-item mb-2">
		<h6 class="text-white">
			...
			<a class="text-white" href="${pageContext.request.contextPath}/ch01/content">Development Environment</a>
		</h6>
	</li>
	<li class="nav-item mb-2">
		<h6 class="text-white">
	...
	<li class="nav-item mb-2">
		<h6 class="text-white">
			...
			<a class="text-white" href="${pageContext.request.contextPath}/ch13/content">Management Object Create / DI</a>
		</h6>
	</li>
	<li class="nav-item mb-2">
		<h6 class="text-white">
